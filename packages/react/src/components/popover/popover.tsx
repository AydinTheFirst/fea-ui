...
const PopoverPortal = ({ className, ...props }: PopoverPortalProps) => {
	...
	return (
		<BasePopover.Portal className={cn(className, slots.portal())} {...props} />
	);
};
...
const PopoverPopup = ({ className, ...props }: PopoverPopupProps) => {
	...
	return (
		<BasePopover.Popup className={cn(className, slots.popup())} {...props} />
	);
};
...
const PopoverArrow = ({ className, ...props }: PopoverArrowProps) => {
	...
	return (
		<BasePopover.Arrow className={cn(className, slots.arrow())} {...props} />
	);
};
...
const PopoverTitle = ({ className, ...props }: PopoverTitleProps) => {
	...
	return (
		<BasePopover.Title className={cn(className, slots.title())} {...props} />
	);
};
...
const PopoverClose = ({ className, children, ...props }: PopoverCloseProps) => {
	const { slots } = usePopover();
